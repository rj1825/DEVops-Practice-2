...
# NAT Gateway to allow private compute instances to access the internet (pull updates/packages)
...
# Isolated Route Table for Database Subnets (no route to internet)
